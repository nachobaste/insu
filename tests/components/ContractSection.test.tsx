...
describe('ContractSection road chips', () => {
  it('renders an All chip and one chip per distinct corridor road for urban contracts', () => {
    ...
    render(<ContractSection title="Urban" categorySlug="urban" contracts={contracts} displayMode="USD" />)
  ...
  it('renders no chip row for non-urban categories', () => {
    ...
    render(<ContractSection title="Nature" categorySlug="nature" contracts={contracts} displayMode="USD" />)
